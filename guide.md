...
<img src="./images/schematic.png" width="640" alt="Transistor tester schematic">
...
<img src="./images/01_inventory_setup/IMG_004_kit-inventory.webp" width="520" alt="Full kit laid out">
...
<img src="./images/01_inventory_setup/IMG_015_resistor-sheet.webp" width="520" alt="Resistors sorted onto a labeled value chart">
...
<img src="./images/01_inventory_setup/IMG_014_pcb-bare.webp" width="300" alt="Bare PCB, component side">
<img src="./images/01_inventory_setup/IMG_008_pcb-bottom.webp" width="300" alt="Bare PCB, solder side">
...
<img src="./images/02_solder_tip_cleaning/IMG_022_iron-label.webp" width="300" alt="Soldering iron">
<img src="./images/02_solder_tip_cleaning/IMG_026_iron-stand.webp" width="300" alt="Cleaning the tip in brass wool">
...
<img src="./images/03_first_component/IMG_017_insert-component.webp" width="360" alt="Inserting a component">
...
<img src="./images/03_first_component/IMG_036_solder-joint.webp" width="360" alt="Soldering a joint from the back">

**3. Check the joint.** A good joint is smooth and shiny and shaped like a little volcano around the
lead — not a dull ball.

<img src="./images/03_first_component/IMG_041_solder-fillet.webp" width="360" alt="Close-up of a clean solder fillet">

**4. Trim the lead.** Snip the excess lead flush with the top of the joint.

<img src="./images/03_first_component/IMG_042_trim-leads.webp" width="360" alt="Trimming the excess lead">
...
<img src="./images/04_populate_resistors/IMG_049_insert-resistors.webp" width="360" alt="Inserting resistors into the board">
...
<img src="./images/04_populate_resistors/IMG_059_populate.webp" width="360" alt="Board with all resistors installed">
...
<img src="./images/05_install_caps/IMG_060_kit-inventory.webp" width="520" alt="Remaining components laid out">
...
<img src="./images/05_install_caps/IMG_064_install-caps.webp" width="360" alt="Capacitors installed on the board">
...
<img src="./images/06_mount_transistors/IMG_070_board-back.webp" width="360" alt="Board with semiconductors installed">
...
<img src="./images/06_mount_transistors/IMG_067_board-side.webp" width="360" alt="Side view showing component heights">
...
<img src="./images/07_final_components/IMG_071_ic-socket.webp" width="360" alt="IC socket soldered to the board">

**Microcontroller.** Once the socket is in, press the **ATMEGA328** into it, lining up the notches.

<img src="./images/07_final_components/IMG_073_install-ic.webp" width="360" alt="ATMEGA328 seated in its socket">
...
<img src="./images/07_final_components/IMG_075_install-zif.webp" width="360" alt="ZIF test socket installed">
...
<img src="./images/07_final_components/IMG_076_install-lcd.webp" width="360" alt="LCD display module and header">
...
<img src="./images/07_final_components/IMG_080_battery-clip.webp" width="360" alt="9V battery clip attached, board nearly complete">
...
<img src="./images/08_testing/IMG_082_test-meter-none.webp" width="300" alt="Checking the board with a multimeter, no reading">
<img src="./images/08_testing/IMG_084_test-meter-pushed.webp" width="300" alt="Multimeter showing a reading during test">
...
> joints and recheck against the [schematic](./images/schematic.png).
